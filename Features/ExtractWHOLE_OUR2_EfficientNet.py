...
CHECKPOINT_NAME =   'WHOLE_OUR2_EfficientNet/OUR_EfficientNet-epoch=21-valid_loss_epoch=0.216.ckpt'
...
class FeatureExtractor():
    def __init__(self, rootFolder,
                 feature="ResNET",
                 video="LQ",
                 back_end="our2_whole_yf_efficientnet",
                 overwrite=False,
                 transform="crop",
                 tmp_HQ_videos=None,
                 grabber="opencv",
...
if __name__ == "__main__":
    ...
    # feature setup
    parser.add_argument('--back_end', type=str, default="our2_whole_yf_efficientnet",
                        help="Backend WHOLE_OUR2_EfficientNet [default:our2_whole_yf_efficientnet]")
