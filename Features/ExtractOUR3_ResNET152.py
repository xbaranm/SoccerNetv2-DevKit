...
### Import model here ###
import timm
from OUR3_ResNET_152 import OUR_ResNET_152
### Import dataset here ###
from SoccernetDataset import SoccernetDataset
############################################################################

CHECKPOINT_NAME =   'OUR3_ResNET_152/OUR_ResNET_152-epoch=98-valid_loss_epoch=0.185.ckpt'
...
class FeatureExtractor():
    def __init__(self, rootFolder,
        ...
        self.model = OUR_ResNET_152.load_from_checkpoint(os.path.join(CHECKPOINT_PATH, CHECKPOINT_NAME), output="features")
...
if __name__ == "__main__":
    ...
    # feature setup
    parser.add_argument('--back_end', type=str, default="our3_yf_resnet152",
                        help="Backend OUR3_ResNET-152 [default:our3_yf_resnet152]")
