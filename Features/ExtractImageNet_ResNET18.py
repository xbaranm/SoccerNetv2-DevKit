...
CHECKPOINT_NAME =   'SIMCLR_ResNET_18/ResNET_18-epoch=67-valid_loss_epoch=0.205.ckpt'
...
if __name__ == "__main__":
    ...
    # feature setup
    parser.add_argument('--back_end', type=str, default="imagenet_resnet18",
                        help="Backend ImageNet_ResNET-18 [default:imagenet_resnet18]")
