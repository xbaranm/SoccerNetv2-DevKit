...
### Import model here ###
import timm
from OUR_ResNET_152 import OUR_ResNET_152
### Import dataset here ###
from SoccernetDataset import SoccernetDataset
############################################################################

CHECKPOINT_NAME =   'OUR2_ResNET_152/OUR_ResNET_152-epoch=84-valid_loss_epoch=0.278.ckpt'
...
if __name__ == "__main__":
    ...
    # feature setup
    parser.add_argument('--back_end', type=str, default="our2_yf_resnet152",
                        help="Backend OUR2_ResNET-152 [default:our2_yf_resnet152]")
