...
### Import model here ###
import timm
from EfficientNet_B5 import EfficientNet_B5
...
if __name__ == "__main__":
    ...
    # feature setup
    parser.add_argument('--back_end', type=str, default="efficientnet_b5",
                        help="Backend EfficientNet_B5 [default:efficientnet_b5]")
